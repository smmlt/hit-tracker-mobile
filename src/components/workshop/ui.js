...
const words = {
  en: {
    ...
    videoRequired: "Add a valid YouTube URL.",
    imageRequired: "Choose an image before switching from video.",
    imagePickerError: "Could not select the image.",
  ...
  uk: {
    ...
    media: "Медіа програми",
    image: "Зображення",
    chooseImage: "Обрати зображення",
    youtubeUrl: "Посилання YouTube",
    videoRequired: "Додайте коректне посилання YouTube.",
    imageRequired: "Оберіть зображення перед перемиканням із відео.",
    imagePickerError: "Не вдалося обрати зображення.",
