...
export const createStyles = (theme, compact = false) => StyleSheet.create({
  ...
  input: { backgroundColor: theme.background, borderRadius: 4, color: theme.textPrimary, fontFamily: 'Inter', fontSize: 13, height: 44, paddingHorizontal: 5, textAlign: 'center', width: compact ? 55 : 58 },
  ...
  setRow: { alignItems: 'center', flexDirection: 'row', gap: compact ? 3 : 6, minHeight: 48 },
  startHint: { color: theme.textSecondary, fontFamily: 'Inter', fontSize: 12 },
  table: { width: compact ? 344 : 366 },
  tableHeader: { alignItems: 'center', flexDirection: 'row', gap: compact ? 3 : 6, minHeight: 28 },
});
