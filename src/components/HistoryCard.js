...
import { SetRow } from './SetRow'; // Переконайся, що шлях правий і файл існує
...
export function HistoryCard({ workout, index, isExpanded, onToggleExpand, onDelete }) {
  ...
  const formattedDate = new Date(workout.createdAt || workout.startDate).toLocaleString('en-US', {
