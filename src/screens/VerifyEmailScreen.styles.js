...
export const styles = StyleSheet.create({
  ...
  title: { color: palette.blackPure, fontSize: 28, fontWeight: '700', marginBottom: 4 },
  subtitle: { color: palette.grayWarm, fontSize: 18, lineHeight: 23, marginBottom: 44 },
  ...
  codeCell: { alignItems: 'center', borderColor: palette.surfacePlaceholder, borderRadius: 10, borderWidth: 2, flex: 1, height: 71, justifyContent: 'center', maxWidth: 57 },
  codeCellFocused: { borderColor: palette.inkMuted },
  ...
  codeDigit: { color: palette.gray900, fontSize: 28, fontWeight: '600' },
  hiddenCodeInput: { ...StyleSheet.absoluteFillObject, color: palette.transparent, opacity: 0.01 },
  status: { color: palette.surfacePlaceholder, fontSize: 15, fontWeight: '700', marginTop: 24, textAlign: 'center' },
  warning: { color: palette.red700, fontSize: 13, lineHeight: 18, marginTop: 10, textAlign: 'center' },
  lockedBox: { alignItems: 'center' },
  requestCode: { color: palette.blackPure, fontSize: 14, fontWeight: '700', marginTop: 12 },
  bottomLinkContainer: { alignItems: 'center', marginTop: 'auto', paddingTop: 48 },
  bottomText: { color: palette.blackPure, fontSize: 15, fontWeight: '700' },
});
